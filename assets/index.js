...
`}</span>
        ...
        `}getServicesListHTML(){let e=this.serviceContext.get(`services`),t=this.searchQuery;if(!e||e.length===0)return``;let n=e.filter(e=>{if(!t)return!0;let n=e.fields.name?.toLowerCase()||``,r=(e.fields.catalogues?.websites||[]).some(e=>e.name?.toLowerCase().includes(t));return n.includes(t)||r});return n.length===0?this.html`
                <div class="no-results">
                    No services found matching your search
                </div>
            `:this.html`
            ${n.map((e,t)=>{let r=e.fields.catalogues.websites,i=r&&r.length>0,a=e.fields.main_url&&e.fields.main_url!==`False`?e.fields.main_url:``,o=this.html`
                    <plain-nav-item
...
}`;function Ne(e,t){return e?e.startsWith(`http://`)||e.startsWith(`https://`)?e:`${t}${e}`:``}function Pe(e,t,n,r,i){if(!e||!t)return i||`#`;let a=n.filter(e=>e._sourceHost===r);for(let n of a){let i=n.fields?.catalogues?.websites||[];for(let n of i)if(n.model===e)return`${r}/offering/${n.view_id}/${t}`}for(let i of n){let n=i.fields?.catalogues?.websites||[];for(let i of n)if(i.model===e)return`${r}/offering/${i.view_id}/${t}`}return i||`#`}function Fe(e,t=1){let n=e.startsWith(`#`)?e.slice(1):e,r=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),a=parseInt(n.slice(4,6),16);return`rgba(${r}, ${i}, ${a}, ${t})`}function Ie(e,t,n){if(!e||!t||t.length===0)return e;let r=e;return[...t].sort((e,t)=>t.length-e.length).forEach(e=>{if(!e)return;let t=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),i=RegExp(`\\b(${t}\\w*)`,`gi`),a=n.startsWith(`#`)?Fe(n,.2):`${n}33`;r=r.replace(i,`<mark style="background-color: ${a};">$1</mark>`)}),r}var Le=`.score-badge {
    display: flex;
    align-items: center;
    gap: 0.375rem;
    background-color: #f3f4f6;
...
.toast-item.success .toast-progress {
    background: rgba(255, 255, 255, 0.4);
} `,st={name:`agora-home`,private:!0,version:`1.0.0`,type:`module`,scripts:{dev:`vite`,build:`tsc && vite build`,preview:`vite preview`,"create-component":`node ./scripts/create.cjs`},devDependencies:{"plain-ts":`npm:plain-ts@latest`,typescript:`~5.9.3`,vite:`npm:rolldown-vite@7.1.14`},overrides:{vite:`npm:rolldown-vite@7.1.14`},dependencies:{marked:`^17.0.1`}};const C={APP_NAME:st.name,VERSION:st.version,API_HOST:`http://localhost:8010`,AI_HOST:`http://localhost:2020`,TRANSLATION_HOST:null,ENABLED_AI:!0,DEBUG_MODE:!1,IS_METAGORA:!1,MAX_HEIGHT:null,VISIBLE_LOGO:!0};var ct=class extends i{constructor(){super(`toast-container`,ot)}template(){return this.html`
        ...
        `,t.appendChild(n);let a=n.querySelector(`.toast-close`);a&&a.addEventListener(`click`,()=>this.removeToast(n)),setTimeout(()=>{this.removeToast(n)},i)}removeToast(e){if(!e.parentElement)return;e.classList.remove(`fade-in`),e.classList.add(`fade-out`);let t=n=>{n.animationName===`slideOut`&&(e.removeEventListener(`animationend`,t),e.remove())};e.addEventListener(`animationend`,t)}getIcon(e){return{error:`✕`,warning:`⚠`,info:`ℹ`,success:`✓`}[e]}};function lt(e,t=`info`,n=5e3){if(!C.DEBUG_MODE)return;let r=document.querySelector(`agora-app`)?.shadowRoot?.querySelector(`toast-container`);r&&r.addToast({message:e,type:t,duration:n})}function w(e,t){if(!C.DEBUG_MODE)return;let n=e instanceof Error?e.message:e,r=t?`[${t}] ${n}`:n;lt(r,`error`,8e3)}window.customElements.define(`toast-container`,ct);var T={GET_AGORA_SERVICES:`/catalogue-api/v2/acceleration-services/1`,GET_AGORA_SEARCH_RESULTS:`/elastic/search`,GET_AGORA_INGEST_MODEL:`/elastic/ingest`,SEND_MESSAGE:`/assistant/rag/stream`,FETCH_ELEMENT:`/catalogue-api/v2`,GET_AIDA_API_KEY:`/catalogue-api/v2/api-key/aida`};const E={GET_ALL_AGORA_URLS:async()=>[`https://agora.unite-university.eu/`,`https://eugreen.pre.widening.eu/`,`https://eudres.widening.eu/`,`https://civis.widening.eu/`,`https://aupaeu.widening.eu/`,`https://forthem.widening.eu/`,`https://eutopia-agora.widening.eu/`,`https://circle-u.widening.eu/`,`https://heroes.widening.eu/`,`https://uninovis.widening.eu/`,`https://foreu4all.widening.eu/`],GET_AGORA_SERVICES:async e=>{try{let t=`${e}${T.GET_AGORA_SERVICES}`,n=await fetch(t);if(!n.ok)throw w(Error(`Failed to fetch Agora services from ${t}`),`GET_AGORA_SERVICES`),Error(`Something went wrong while fetching the Agora services`);return await n.json()}catch(e){throw w(e,`GET_AGORA_SERVICES`),e}},GET_AGORA_SEARCH_RESULTS:async(e,t,n,r,i)=>{if(!t||t.length===0)throw Error(`No query provided`);if(n.length===0)throw Error(`No models provided for the search`);let a=`${e}${T.GET_AGORA_SEARCH_RESULTS}?query=${t}&models=${n.join()}`;try{let e=await fetch(a);if(!e.ok&&e.status===404){let t=await e.json();throw Error(JSON.stringify(t))}return await e.json()}catch(e){throw w(e,`GET_AGORA_SEARCH_RESULTS`),e}},GET_AGORA_INGEST_MODEL:async(e,t)=>{let n=`${e}${T.GET_AGORA_INGEST_MODEL}/${t}`;try{let e=await fetch(n);if(!e.ok){let t=await e.json();throw Error(t.message)}return await e.json()}catch(e){throw w(e,`GET_AGORA_INGEST_MODEL`),e}},SEND_MESSAGE:async(e,t,n=[],r=``,i=it.GPT_4O_MINI,a=at.OPENAI,o=.7)=>{let s={message:t,history:n,context:r,model:i,provider:a,temperature:o},c=`${e}${T.SEND_MESSAGE}`;try{let e=await fetch(c,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(s)});if(!e.ok)throw Error(`Something went wrong while sending message`);return e.body instanceof ReadableStream?e:await e.json()}catch(e){throw w(e,`SEND_MESSAGE`),e}},FETCH_ELEMENT:async(e,t,n)=>{let r=`${e}${T.FETCH_ELEMENT}/${t}/${n}`;try{let e=localStorage.getItem(`aida_ak`);if(!e)throw Error(`AIDA API key not found. Please ensure you are properly authenticated.`);let i=await fetch(r,{method:`GET`,headers:{accept:`application/json`,Authorization:`Bearer ${e}`}});if(!i.ok){if(i.status===404){let e=await i.json();throw Error(JSON.stringify(e))}if(i.status===401||i.status===403){let e=await i.json();throw Error(JSON.stringify(e))}throw Error(`Failed to fetch element ${t}/${n}`)}return await i.json()}catch(e){throw w(e,`FETCH_ELEMENT`),e}},GET_AIDA_API_KEY:async(e,t=[])=>{try{let n=new URLSearchParams;t&&t.length>0&&n.append(`models`,t.join(`,`));let r=`${e}${T.GET_AIDA_API_KEY}${n.toString()?`?${n.toString()}`:``}`,i=await fetch(r,{method:`GET`,headers:{accept:`application/json`}});if(!i.ok){if(i.status===400){let e=await i.json();throw Error(e.error?.message||`Bad request when fetching API key`)}if(i.status===500){let e=await i.json();throw Error(e.error?.message||`Server error when fetching API key`)}throw Error(`Something went wrong while fetching AIDA API key`)}return await i.json()}catch(e){throw w(e,`GET_AIDA_API_KEY`),e}},GET_MULTIPLE_AIDA_API_KEYS:async(e,t={})=>{let n={};return await Promise.all(e.map(async e=>{try{let r=await E.GET_AIDA_API_KEY(e,t[e]);r?.token?.jwt_token&&(n[e]=r.token.jwt_token)}catch(t){console.warn(`Failed to fetch API key for host: ${e}`,t)}})),n}},D=(e,t)=>{let n=[];function r(e){for(let i in e)Object.prototype.hasOwnProperty.call(e,i)&&(i===t&&n.push({[t]:e[i]}),typeof e[i]==`object`&&e[i]!==null&&r(e[i]))}return r(e),n};var ut=class{deps;callbacks;messageBuffer=``;isFirstChunk=!0;shouldResetResults=!1;constructor(e,t){this.deps=e,this.callbacks=t}async chat(e){if(!e){console.warn(`No message provided`);return}this.callbacks.showSpinner(),this.isFirstChunk=!0,this.messageBuffer=``,this.deps.signals.emit(S.CHAT_STARTED),this.storeMessageInChatContext(e,`user`),this.deps.signals.emit(S.CHAT_USER_MESSAGE);try{let t=this.deps.configContext.get(`AI_HOST`),n=this.formatMessageHistory(),r=this.extractMentionsFromMessage(e),i=this.filterResultsByMentions(r),a=this.buildChatContext(i),o=await E.SEND_MESSAGE(t,e,n,a);if(o.body instanceof ReadableStream)await this.handleStreamingResponse(o);else{let e=o,t=e.response||e.message||``;this.storeMessageInChatContext(t,`ai`),this.deps.signals.emit(S.CHAT_MESSAGE_COMPLETE,t)}}catch(e){console.error(`Chat error:`,e)}finally{this.callbacks.hideSpinner(),this.shouldResetResults=!0}}buildChatContext(e){let t=this.deps.companyContext.get(`name`)||`the alliance`,n=this.deps.resultContext.get(`data`)?.length||0,r=e.map(e=>` >> Resource: ${JSON.stringify(e)}\n`),i=[`You are a helpful assistant working in the Metagora platform.`,`Metagora is a HUB that grants access to all university resources and services within all the university alliances that are using the Agora platform.`,`Agora is a platform to manage and share university resources within a university alliance.`,`An Agora is a service that serves as a central hub that provides access to services and resources offered by the alliance members.`,`A university alliance is a collaboration between multiple universities to share resources, knowledge, and services for the benefit of their students and staff.`,`This site is the Metagora.`].join(`
`)+`
...
`,s,o].join(`
`)}formatMessageHistory(){return(this.deps.chatContext.get(`history`)||[]).map(e=>({role:e.author===`user`?`user`:`ai`,content:e.content}))}storeMessageInChatContext(e,t){if(!e||e.trim()===``)return;let n=this.deps.chatContext.get(`history`)||[];n.push({content:e,author:t,time:new Date().toLocaleTimeString()}),this.deps.chatContext.set({history:n}),this.callbacks.updateClearButtonVisibility()}async handleStreamingResponse(e){let t=e.body.getReader(),n=new TextDecoder;try{for(;;){let{done:e,value:r}=await t.read();if(e)break;let i=n.decode(r,{stream:!0});this.handleChunk(i)}this.messageBuffer&&=(this.storeMessageInChatContext(this.messageBuffer,`ai`),this.deps.signals.emit(S.CHAT_MESSAGE_COMPLETE,this.messageBuffer),``)}catch(e){throw console.error(`Stream reading error:`,e),e}}splitChunkByTags(e){let t=/(\[\$\w+\])(.*?)(?=\[\$\w+\]|$)/gs,n=[],r;for(;(r=t.exec(e))!==null;){let e=r[1],t=r[2];if(e===`[$done]`){n.length>0&&(n[n.length-1].content+=` [$done]`);continue}n.push({tag:e,content:t})}return n}handleChunk(e){this.splitChunkByTags(e).forEach(e=>{if(e.tag===`[$artifact]`)try{let t=JSON.parse(e.content.replace(/'/g,`"`));this.handleChatResults(t)}catch(e){console.error(`Error parsing artifact:`,e)}else if(e.tag===`[$message]`){let t=e.content.includes(`[$done]`),n=t?e.content.split(`[$done]`)[0]:e.content;this.handleChatMessage({isFirstChunk:this.isFirstChunk,isLastChunk:t,message:n}),this.isFirstChunk&&=!1}})}handleChatMessage(e){if(e.isFirstChunk&&this.callbacks.hideSpinner(),e.isLastChunk){let t=this.messageBuffer+e.message;this.storeMessageInChatContext(t,`ai`),this.deps.signals.emit(S.CHAT_MESSAGE_COMPLETE,t),this.messageBuffer=``;return}this.messageBuffer+=e.message,e.message&&this.deps.signals.emit(S.CHAT_MESSAGE_CHUNK,{chunk:e.message,fullMessage:this.messageBuffer})}async handleChatResults(e){if(!e||e.length===0)return;let t={grouped:[],data:[]};this.shouldResetResults||(t.data=this.deps.resultContext.get(`data`)||[],t.grouped=this.deps.resultContext.get(`grouped`)||[]),this.shouldResetResults&&=!1;let n=this.deps.serviceContext.get(`services`)||[],r=D(n,`websites`).flatMap(e=>e.websites),i={},a=e=>{t.data.push(e),t.grouped=[...new Set(t.data.map(e=>e.service))].sort().map(e=>({service:e,items:t.data.filter(t=>t.service===e)})),this.deps.resultContext.set(t,!0),this.deps.signals.emit(S.CHAT_RESULTS_UPDATED,t.grouped),this.deps.signals.emit(S.RESULTS_FETCHED,t.data)};this.deps.signals.emit(S.CHAT_FETCHING_RESULTS,!0),(async()=>{for(let t of e){i[t.model]=r.find(e=>e.model===t.model)?.name||null;let e=t.model,o=null;if(n.forEach(t=>{let n=t.fields?.catalogues?.websites;if(!n)return;let r={};n.forEach(t=>{if(!t.model||t.model!==e)return;let n={model:t.model,model_verbose_name:t.model_verbose_name,model_website:t.website,model_view_url:t.url,model_view_id:t.view_id};r[t.model]=n}),e in r&&(o={service:t.fields.name,serviceCategory:x(t.fields.category),models:r})}),!o)continue;let s=o,c;try{c=await E.FETCH_ELEMENT(this.deps.configContext.get(`API_HOST`),t.model,Number(t.source_id))}catch(e){console.error(`Error fetching element:`,e);continue}if(!c)continue;Object.entries(c.fields).forEach(([e,t])=>{if(typeof t==`string`&&(t.startsWith(`[`)||t.startsWith(`{`)))try{let n=xe(t);n&&(c.fields[e]=n.name||t)}catch(n){console.warn(`Could not parse field ${e} with value ${t} as JSON:`,n)}});let l=c.fields?.x_image||null;l&&=l.replace(this.deps.configContext.get(`API_HOST`),``);let u=c.fields?.detail_url?s.models[e].model_website+s.models[e].model_view_url:null,d={data:{...c.fields,id:c.id,image:l},featured:c.fields?.featured||!1,featured_fields:[`web_link`,`url`,`website`],model:t.model,model_verbose_name:i[t.model],model_view_url:u,roots:[],score:{absolute:null,relative:null},service:s.service,serviceCategory:s.serviceCategory};a(d)}this.deps.signals.emit(S.CHAT_FETCHING_RESULTS,!1)})()}extractMentionsFromMessage(e){let t=/@([^@\n]+?)(?=\s*@|\s*$)/g,n=[],r;for(;(r=t.exec(e))!==null;){let e=r[1].trim();e&&n.push(e.toLowerCase())}return n}filterResultsByMentions(e){return e.length===0?[]:(this.deps.resultContext.get(`data`)||[]).filter(t=>{let n=this.getResultDisplayName(t).toLowerCase();return e.some(e=>n.includes(e)||e.includes(n))})}getResultDisplayName(e){let t=e.data||{};for(let e of[`name`,`title`,`Name`,`Title`,`headline`,`label`,`display_name`])if(t[e]&&typeof t[e]==`string`)return t[e];return e.model_verbose_name||``}clearChatHistory(){this.deps.chatContext.set({history:[]}),this.messageBuffer=``}newChat(e){this.deps.chatContext.set({history:[]}),this.messageBuffer=``,e(),this.deps.signals.emit(S.NEW_CHAT)}};const dt=async(e,t,n)=>{if(!t||t.trim()===``)return console.warn(`No query provided`),{data:null};if(n.length===0)return console.warn(`No models provided`),{data:null};let r=t.replace(/[^^A-Za-z0-9 ]/g,``),i={raw:r,translated:r};try{return{data:await E.GET_AGORA_SEARCH_RESULTS(e,i.translated,n)}}catch(e){throw console.log(`Error during query:`,JSON.parse(e.message)),w(e,`Search Query`),e}},ft=async(e,t)=>{try{return lt(`Elasticsearch is ingesting the missing model data.\n
            Ingesting missing data from the model: '${t}' into Elasticsearch`,`warning`,1e4),console.warn(`ELASTICSEARCH IS INGESTING\nIngesting missing data from the model: '${t}' into Elasticsearch`),await E.GET_AGORA_INGEST_MODEL(e,t),null}catch(e){return w(e,`Model Data Ingestion`),e}};var pt=class{props;callbacks;constructor(e,t){this.props=e,this.callbacks=t}async search(e){let t=this.props.serviceContext.get(`models`);if(!e||e.trim()===``){console.warn(`No query provided`);return}if(t.length===0){console.warn(`No models provided`);return}this.callbacks.hideSuggestions(),this.callbacks.showSpinner();let n=this.sanitizeQuery(e);if(this.props.configContext.get(`IS_METAGORA`)){let t=this.props.serviceContext.get(`modelsByAgora`)||{},r=new Map;await Promise.all(Object.entries(t).map(async([e,t])=>{if(t.length===0){console.warn(`No models available for Agora at host ${e}`);return}try{let i=(await dt(e,n,t)).data.results;r.set(e,i)}catch(t){console.error(`Error querying Agora at host ${e}\n${t}`),r.set(e,[])}})),this.callbacks.hideSpinner(),this.handleMetagoraSearchResults(e,r);return}try{let r=await dt(this.props.configContext.get(`API_HOST`),n,t);this.callbacks.hideSpinner();let i=r.data.results;this.handleSearchResults(e,i)}catch(t){try{let n=JSON.parse(t.message);if(n.missing_model){let t=await ft(this.props.configContext.get(`API_HOST`),n.missing_model);if(t){console.error(`ELASTICSEARCH INGESTION ERROR\n${t}`),this.callbacks.hideSpinner();return}await this.search(e)}}catch{throw console.error(`SEARCH ERROR\n${t}`),this.callbacks.hideSpinner(),t}}}sanitizeQuery(e){return e.replace(/[^^A-Za-z0-9 ]/g,``)}handleSearchResults(e,t,n=!1){if(this.props.signals.emit(S.RESULTS_FETCHED,t),this.callbacks.updateClearButtonVisibility(t.length>0),t.length===0){this.props.resultContext.set({data:[],grouped:[]},!0);return}this.storeQueryInContext({raw:e,translated:e});let r=this.props.serviceContext.get(`services`),i=[...new Set(r.map(e=>({service:e.fields.name,category:x(e.fields.category),models:D(e,`model`).map(e=>e.model)})))];Qe(t,i);let a=D(r,`websites`).flatMap(e=>e.websites),o=$e(t,a,this.props.configContext.get(`API_HOST`)),s=Ze(o,`absolute`),c=et(s);this.props.resultContext.set({data:s,grouped:c},!0)}handleMetagoraSearchResults(e,t){let n=[];if(t.forEach((e,t)=>{let r=e.map(e=>({...e,_sourceHost:t}));n.push(...r)}),this.props.signals.emit(S.RESULTS_FETCHED,n),this.callbacks.updateClearButtonVisibility(n.length>0),n.length===0){this.props.resultContext.set({data:[],grouped:[]},!0);return}this.storeQueryInContext({raw:e,translated:e});let r=this.props.serviceContext.get(`services`),i=[...new Set(r.map(e=>({service:e.fields.name,category:x(e.fields.category),models:D(e,`model`).map(e=>e.model)})))];Qe(n,i);let a=D(r,`websites`).flatMap(e=>e.websites),o=$e(n,a,``),s=Ze(o,`absolute`),c=tt(s),l=c.flatMap(e=>e.services);this.props.resultContext.set({data:s,grouped:l,groupedByCategory:c},!0)}storeQueryInContext(e){let t=this.props.searchContext.get(`history`)||[],n={history:[...new Set([...t,e.raw])],current:e.translated.split(` `)};this.props.searchContext.set(n)}},mt=class{deps;constructor(e){this.deps=e}checkForMention(e,t){let n=-1;for(let r=t-1;r>=0;r--){let t=e[r];if(t===` `||t===`
...
`}</button>
                    ...
                    <div class="card-body">
                        <span class="icon globe-icon">${this.activeMode===`search`?oe:ae}</span>
                        <textarea 
...
`;const O={catalogue:[`model_verbose_name`],service:[`service`],serviceCategory:[`serviceCategory`],agora:[`_sourceHost`],origin:[`origin`,`x_origin`,`x_home_partner_institution`,`x_home_university`,`x_participating_universities`,`x_host_university`,`x_university`,`x_university_origin`]};var yt=class extends i{selectedFilters;resultContext;filterContext;companyContext;metagoraContext;isCollapsed=!1;collapsedSections=new Set;sectionsInitialized=!1;constructor(){super(`plain-filter-widget`,vt),this.resultContext=this.useContext(m.RESULT,!0),this.filterContext=this.useContext(m.FILTER),this.companyContext=this.useContext(m.COMPANY),this.metagoraContext=this.useContext(m.METAGORA),this.selectedFilters=this.useState({mapping:O,filters:{}}),this.initiFilters()}initiFilters(){let e=this.filterContext.get();this.selectedFilters.set({mapping:O,filters:e?.filters||{}})}getAgoraNameFromHost(e){return(this.metagoraContext.get(`agoras`)||[]).find(t=>t.host===e)?.name||e}truncateText(e,t=30){return e.length<=t?e:e.substring(0,t)+`...`}updateAvailableFilters(){let e=this.resultContext.get()?.data||[],t=Object.values(O).flatMap(e=>e),n={service:[],origin:[],catalogue:[],serviceCategory:[],agora:[]};return t.map(t=>{e.map(e=>{let r=D(e,t),i=Object.keys(O).find(e=>O[e].includes(t));if(!i||![`service`,`origin`,`catalogue`,`serviceCategory`,`agora`].includes(i))return;let a=r.map(e=>e[t]);if(a=a.filter(e=>e),i===`origin`){let e=a.flatMap(e=>b(e));n[i].push(...e)}else if(i===`agora`){let e=a.map(e=>({label:this.getAgoraNameFromHost(e),value:e}));n[i].push(...e)}else n[i].push(...a);if(i===`agora`){let e=new Set;n[i]=n[i].filter(t=>e.has(t.value)?!1:(e.add(t.value),!0))}else n[i]=Array.from(new Set(n[i]))})}),n}clearFilters(){let e={mapping:O,filters:{}};this.selectedFilters.set(e),this.filterContext.set(e,!0)}toggleCollapse(){this.isCollapsed=!this.isCollapsed,this.$(`.filter-widget`)?.classList.toggle(`collapsed`,this.isCollapsed)}toggleSection(e){this.collapsedSections.has(e)?this.collapsedSections.delete(e):this.collapsedSections.add(e),this.render()}template(){if((this.resultContext.get()?.data||[]).length===0)return``;let e=this.updateAvailableFilters(),t=Object.values(e).flatMap(e=>e).length>0;t&&!this.sectionsInitialized&&(this.sectionsInitialized=!0,[`origin`,`service`,`catalogue`,`serviceCategory`,`agora`].forEach(t=>{e[t]&&e[t].length>1&&this.collapsedSections.add(t)}));let n=this.companyContext.get(`primaryColor`);n&&this.style.setProperty(`--primary-color`,n);let r=e.origin.length>1?this.html`
...
}`;function Tt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var k=Tt();function Et(e){k=e}var A={exec:()=>null};function j(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(M.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var Dt=(()=>{try{return!0}catch{return!1}})(),M={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,`i`)},Ot=/^(?:[ \t]*(?:\n|$))+/,kt=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,At=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,N=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,jt=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,P=/(?:[*+-]|\d{1,9}[.)])/,Mt=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Nt=j(Mt).replace(/bull/g,P).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),Pt=j(Mt).replace(/bull/g,P).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),F=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ft=/^[^\n]+/,I=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,It=j(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,I).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Lt=j(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,P).getRegex(),L=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,R=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Rt=j(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,R).replace(`tag`,L).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),zt=j(F).replace(`hr`,N).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,L).getRegex(),z={blockquote:j(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,zt).getRegex(),code:kt,def:It,fences:At,heading:jt,hr:N,html:Rt,lheading:Nt,list:Lt,newline:Ot,paragraph:zt,table:A,text:Ft},Bt=j(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,N).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,L).getRegex(),Vt={...z,lheading:Pt,table:Bt,paragraph:j(F).replace(`hr`,N).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,Bt).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,L).getRegex()},Ht={...z,html:j(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,R).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:A,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:j(F).replace(`hr`,N).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,Nt).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},Ut=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Wt=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Gt=/^( {2,}|\\)\n(?!\s*$)/,Kt=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,B=/[\p{P}\p{S}]/u,V=/[\s\p{P}\p{S}]/u,qt=/[^\s\p{P}\p{S}]/u,Jt=j(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,V).getRegex(),Yt=/(?!~)[\p{P}\p{S}]/u,Xt=/(?!~)[\s\p{P}\p{S}]/u,Zt=/(?:[^\s\p{P}\p{S}]|~)/u,Qt=j(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,Dt?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),$t=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,en=j($t,`u`).replace(/punct/g,B).getRegex(),tn=j($t,`u`).replace(/punct/g,Yt).getRegex(),nn=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,rn=j(nn,`gu`).replace(/notPunctSpace/g,qt).replace(/punctSpace/g,V).replace(/punct/g,B).getRegex(),an=j(nn,`gu`).replace(/notPunctSpace/g,Zt).replace(/punctSpace/g,Xt).replace(/punct/g,Yt).getRegex(),on=j(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,qt).replace(/punctSpace/g,V).replace(/punct/g,B).getRegex(),sn=j(/\\(punct)/,`gu`).replace(/punct/g,B).getRegex(),cn=j(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),ln=j(R).replace(`(?:-->|$)`,`-->`).getRegex(),un=j(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,ln).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),H=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,dn=j(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace(`label`,H).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),fn=j(/^!?\[(label)\]\[(ref)\]/).replace(`label`,H).replace(`ref`,I).getRegex(),pn=j(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,I).getRegex(),mn=j(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,fn).replace(`nolink`,pn).getRegex(),hn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,gn={_backpedal:A,anyPunctuation:sn,autolink:cn,blockSkip:Qt,br:Gt,code:Wt,del:A,emStrongLDelim:en,emStrongRDelimAst:rn,emStrongRDelimUnd:on,escape:Ut,link:dn,nolink:pn,punctuation:Jt,reflink:fn,reflinkSearch:mn,tag:un,text:Kt,url:A},_n={...gn,link:j(/^!?\[(label)\]\((.*?)\)/).replace(`label`,H).getRegex(),reflink:j(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,H).getRegex()},vn={...gn,emStrongRDelimAst:an,emStrongLDelim:tn,url:j(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,hn).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:j(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,hn).getRegex()},yn={...vn,br:j(Gt).replace(`{2,}`,`*`).getRegex(),text:j(vn.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},U={normal:z,gfm:Vt,pedantic:Ht},W={normal:gn,gfm:vn,breaks:yn,pedantic:_n},bn={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},xn=e=>bn[e];function G(e,t){if(t){if(M.escapeTest.test(e))return e.replace(M.escapeReplace,xn)}else if(M.escapeTestNoEncode.test(e))return e.replace(M.escapeReplaceNoEncode,xn);return e}function Sn(e){try{e=encodeURI(e).replace(M.percentDecode,`%`)}catch{return null}return e}function Cn(e,t){let n=e.replace(M.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(M.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(M.slashPipe,`|`);return n}function K(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function wn(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function Tn(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`);r.state.inLink=!0;let c={type:e[0].charAt(0)===`!`?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:r.inlineTokens(s)};return r.state.inLink=!1,c}function En(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
`).map(e=>{let t=e.match(n.other.beginningSpace);if(t===null)return e;let[r]=t;return r.length>=i.length?e.slice(i.length):e}).join(`
`)}var q=class{options;rules;lexer;constructor(e){this.options=e||k}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:`space`,raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let e=t[0].replace(this.rules.other.codeRemoveIndent,``);return{type:`code`,raw:t[0],codeBlockStyle:`indented`,text:this.options.pedantic?e:K(e,`
`)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let e=t[0],n=En(e,t[3]||``,this.rules);return{type:`code`,raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,`$1`):t[2],text:n}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let t=K(e,`#`);(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:`heading`,raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:`hr`,raw:K(t[0],`
...
`):[],a={type:`table`,raw:t[0],header:[],align:[],rows:[]};if(n.length===r.length){for(let e of r)this.rules.other.tableAlignRight.test(e)?a.align.push(`right`):this.rules.other.tableAlignCenter.test(e)?a.align.push(`center`):this.rules.other.tableAlignLeft.test(e)?a.align.push(`left`):a.align.push(null);for(let e=0;e<n.length;e++)a.header.push({text:n[e],tokens:this.lexer.inline(n[e]),header:!0,align:a.align[e]});for(let e of i)a.rows.push(Cn(e,a.header.length).map((e,t)=>({text:e,tokens:this.lexer.inline(e),header:!1,align:a.align[t]})));return a}}lheading(e){let t=this.rules.block.lheading.exec(e);if(t)return{type:`heading`,raw:t[0],depth:t[2].charAt(0)===`=`?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(e){let t=this.rules.block.paragraph.exec(e);if(t){let e=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:`paragraph`,raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(e){let t=this.rules.block.text.exec(e);if(t)return{type:`text`,raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){let t=this.rules.inline.escape.exec(e);if(t)return{type:`escape`,raw:t[0],text:t[1]}}tag(e){let t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&this.rules.other.startATag.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:`html`,raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){let t=this.rules.inline.link.exec(e);if(t){let e=t[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(e)){if(!this.rules.other.endAngleBracket.test(e))return;let t=K(e.slice(0,-1),`\\`);if((e.length-t.length)%2==0)return}else{let e=wn(t[2],`()`);if(e===-2)return;if(e>-1){let n=(t[0].indexOf(`!`)===0?5:4)+t[1].length+e;t[2]=t[2].substring(0,e),t[0]=t[0].substring(0,n).trim(),t[3]=``}}let n=t[2],r=``;if(this.options.pedantic){let e=this.rules.other.pedanticHrefTitle.exec(n);e&&(n=e[1],r=e[3])}else r=t[3]?t[3].slice(1,-1):``;return n=n.trim(),this.rules.other.startAngleBracket.test(n)&&(n=this.options.pedantic&&!this.rules.other.endAngleBracket.test(e)?n.slice(1):n.slice(1,-1)),Tn(t,{href:n&&n.replace(this.rules.inline.anyPunctuation,`$1`),title:r&&r.replace(this.rules.inline.anyPunctuation,`$1`)},t[0],this.lexer,this.rules)}}reflink(e,t){let n;if((n=this.rules.inline.reflink.exec(e))||(n=this.rules.inline.nolink.exec(e))){let e=(n[2]||n[1]).replace(this.rules.other.multipleSpaceGlobal,` `),r=t[e.toLowerCase()];if(!r){let e=n[0].charAt(0);return{type:`text`,raw:e,text:e}}return Tn(n,r,n[0],this.lexer,this.rules)}}emStrong(e,t,n=``){let r=this.rules.inline.emStrongLDelim.exec(e);if(!(!r||r[3]&&n.match(this.rules.other.unicodeAlphaNumeric))&&(!(r[1]||r[2])||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=0,c=r[0][0]===`*`?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,t=t.slice(-1*e.length+n);(r=c.exec(t))!=null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i)continue;if(a=[...i].length,r[3]||r[4]){o+=a;continue}else if((r[5]||r[6])&&n%3&&!((n+a)%3)){s+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o+s);let t=[...r[0]][0].length,c=e.slice(0,n+r.index+t+a);if(Math.min(n,a)%2){let e=c.slice(1,-1);return{type:`em`,raw:c,text:e,tokens:this.lexer.inlineTokens(e)}}let l=c.slice(2,-2);return{type:`strong`,raw:c,text:l,tokens:this.lexer.inlineTokens(l)}}}}codespan(e){let t=this.rules.inline.code.exec(e);if(t){let e=t[2].replace(this.rules.other.newLineCharGlobal,` `),n=this.rules.other.nonSpaceChar.test(e),r=this.rules.other.startingSpaceChar.test(e)&&this.rules.other.endingSpaceChar.test(e);return n&&r&&(e=e.substring(1,e.length-1)),{type:`codespan`,raw:t[0],text:e}}}br(e){let t=this.rules.inline.br.exec(e);if(t)return{type:`br`,raw:t[0]}}del(e){let t=this.rules.inline.del.exec(e);if(t)return{type:`del`,raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(e){let t=this.rules.inline.autolink.exec(e);if(t){let e,n;return t[2]===`@`?(e=t[1],n=`mailto:`+e):(e=t[1],n=e),{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}url(e){let t;if(t=this.rules.inline.url.exec(e)){let e,n;if(t[2]===`@`)e=t[0],n=`mailto:`+e;else{let r;do r=t[0],t[0]=this.rules.inline._backpedal.exec(t[0])?.[0]??``;while(r!==t[0]);e=t[0],n=t[1]===`www.`?`http://`+t[0]:t[0]}return{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}inlineText(e){let t=this.rules.inline.text.exec(e);if(t){let e=this.lexer.state.inRawBlock;return{type:`text`,raw:t[0],text:t[0],escaped:e}}}},J=class e{tokens;options;state;inlineQueue;tokenizer;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||k,this.options.tokenizer=this.options.tokenizer||new q,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={other:M,block:U.normal,inline:W.normal};this.options.pedantic?(t.block=U.pedantic,t.inline=W.pedantic):this.options.gfm&&(t.block=U.gfm,this.options.breaks?t.inline=W.breaks:t.inline=W.gfm),this.tokenizer.rules=t}static get rules(){return{block:U,inline:W}}static lex(t,n){return new e(n).lex(t)}static lexInline(t,n){return new e(n).inlineTokens(t)}lex(e){e=e.replace(M.carriageReturn,`
...
`}
        ...
        `}initializeHandlers(){this.contextHandler=new Ln({configContext:this.configContext,companyContext:this.companyContext,serviceContext:this.serviceContext,modalContext:this.modalContext,metagoraContext:this.metagoraContext,getAttribute:e=>this.getAttribute(e),hasAttribute:e=>this.hasAttribute(e)}),this.layoutHandler=new Rn({resultContext:this.resultContext,chatContext:this.chatContext,$:e=>this.$(e)},{getCurrentMode:()=>this.currentMode,setCurrentMode:e=>{this.currentMode=e},getPanelHandler:()=>this.panelHandler}),this.panelHandler=new zn({resultContext:this.resultContext,$:e=>this.$(e)})}async init(){await this.contextHandler.initializeAll()}afterRender(){let e=this.configContext.get(`MAX_HEIGHT`);if(e){let t=this.shadowRoot?.querySelector(`.agora-app-wrapper`);t&&(t.style.maxHeight=e)}}connectors(){this.setupSignalConnections(),this.panelHandler.setupEventListeners(),this.layoutHandler.initializeLayout()}setupSignalConnections(){let e=this.$(`plain-agora-input`),t=this.$(`plain-chat-window`);e&&(this.signals.connect(e,S.RESULTS_FETCHED,e=>this.layoutHandler.updateVisibility(e)),this.signals.connect(e,S.RESULTS_CLEARED,()=>this.layoutHandler.updateVisibility(null))),t&&(this.signals.connect(e,S.CHAT_USER_MESSAGE,()=>{t.handleUserMessage()}),this.signals.connect(e,S.CHAT_MESSAGE_CHUNK,e=>{t.handleMessageChunk(e)}),this.signals.connect(e,S.CHAT_MESSAGE_COMPLETE,()=>{t.handleMessageComplete()}),this.signals.connect(e,S.CHAT_FETCHING_RESULTS,e=>{t.handleFetchingResults(e)}),this.signals.connect(e,S.CHAT_STARTED,()=>{this.layoutHandler.showChatWindow()}),this.signals.connect(e,S.NEW_CHAT,()=>{this.layoutHandler.resetToInitialState(),t.render()}),this.signals.connect(e,S.MODE_SWITCH,e=>{this.layoutHandler.handleModeSwitch(e)}))}};window.customElements.define(`${C.IS_METAGORA?`metagora`:`agora`}-app-v2`,Bn);
...
@keyframes skeleton-shimmer {
    ...
    100% {
...
}`;const m={COMPANY:`company`,CONFIG:`config`,RESULT:`result`,SERVICE:`service`,METAGORA:`metagora`,SEARCH:`search`,FILTER:`filter`,MODAL:`modal`,CHAT:`chat`,VISUAL_CONFIG:`visualConfig`};var ne={name:`agora-home`,private:!0,version:`1.0.0`,type:`module`,scripts:{dev:`vite`,build:`tsc && vite build`,preview:`vite preview`,"create-component":`node ./scripts/create.cjs`},devDependencies:{"plain-ts":`npm:plain-ts@latest`,typescript:`~5.9.3`,vite:`npm:rolldown-vite@7.1.14`},overrides:{vite:`npm:rolldown-vite@7.1.14`},dependencies:{marked:`^17.0.1`}};const h={APP_NAME:ne.name,VERSION:ne.version,API_HOST:`http://localhost:8010`,AI_HOST:`http://localhost:2020`,TRANSLATION_HOST:null,ENABLED_AI:!0,DEBUG_MODE:!1,IS_METAGORA:!1,MAX_HEIGHT:null,VISIBLE_LOGO:!0},g={id:0,name:`Home Visual Configuration`,primary_color:`#9747FF`,secondary_color:`#f5f5f5`,greeting_headline:`What will you discover?`,greeting_text:`From funding and courses to shared infrastructure and researcher matchmaking — find the right resources to accelerate your career in the {name} Agora.`,greeting_prompt_headline:`Try searching for`,greeting_prompt_suggestion:[`funding opportunities`,`research partners`,`upcoming events`,`shared infrastructure`,`challenges`],trending_searches_headline:`TRENDING SEARCHES`,trending_searches_suggestion:[`latest ai courses`,`innovation projects`,`research collaboration`],searchbar_placeholder:`Search for funding, courses, infrastructure...`,agora_or_datagora:`agora`,central_widget_type:`carousel`,title_font:`Geist`,body_font:`Geist Mono`,open_new_tab_on_menu_click:!0,agora_name_visible:!0,background_image:!1,language:`en_GB`};var re=class extends i{companyContext;visualConfigContext;constructor(){super(`plain-logo`,te),this.companyContext=this.useContext(m.COMPANY,!0),this.visualConfigContext=this.useContext(m.VISUAL_CONFIG,!0)}renderSkeletonLoader(){return this.html`
        ...
        `:this.renderSkeletonLoader()}};window.customElements.define(`plain-logo`,re);var ie=`.plain-nav-menu-wrapper {
    width: 100%;
    height: fit-content;
...
`};var ge=class extends i{companyContext;constructor(){super(`plain-nav-item`,ae),this.companyContext=this.useContext(`company`)}showTooltip(e){let t=e.currentTarget,n=t.querySelector(`.tooltip`);if(!n)return;let r=t.getBoundingClientRect();n.style.position=`fixed`,n.style.top=`${r.top-n.offsetHeight-8}px`,n.style.left=`${r.left+r.width/2-n.offsetWidth/2}px`,n.style.visibility=`visible`,n.style.opacity=`1`}hideTooltip(e){let t=e.currentTarget.querySelector(`.tooltip`);t&&(t.style.visibility=`hidden`,t.style.opacity=`0`)}template(){let e=this.props.menuTargetMode,t=this.props.openInNewTab,n=e?e!==`same-tab`:!(t===!1||t===`false`||t===``),r=n?`_blank`:`_self`,i=n?`noopener noreferrer`:``,a=this.props.mainUrl?this.html`
                ...
                >
                    ${!this.props.companyName&&this.props.serviceIcon&&S[this.props.serviceIcon]?this.html`<span class="item-icon">${S[this.props.serviceIcon]}</span>`:``}
                    ${this.props.serviceName}
                    ${this.props.mainUrl?this.html`<span class="nav-arrow">${b}</span>`:``}
            ...
            <div class="plain-nav-item-wrapper ">
                ...
                >
                    ${this.props.companyName?this.html`
                        ...
                        `:!this.props.mainUrl&&this.props.serviceIcon&&S[this.props.serviceIcon]?this.html`
                                <span class="item-icon">${S[this.props.serviceIcon]}</span>
                            `:``}
...
`}</span>
        ...
        `}};window.customElements.define(`plain-catalogue-item`,ve);function C(e){return!e||Array.isArray(e)?[]:e.websites??[]}var ye=class extends i{serviceContext;companyContext;visualConfigContext;searchQuery=``;searchTimeout=null;constructor(){super(`plain-nav-menu`,ie),this.serviceContext=this.useContext(m.SERVICE,!0),this.companyContext=this.useContext(m.COMPANY,!0),this.visualConfigContext=this.useContext(m.VISUAL_CONFIG,!0)}handleSearch(e){let t=e.target.value.toLowerCase();this.searchTimeout&&clearTimeout(this.searchTimeout),this.searchTimeout=window.setTimeout(()=>{this.searchQuery=t,this.updateList()},300)}updateList(){let e=this.$(`#services-list`);e&&(e.innerHTML=this.getServicesListHTML())}renderSkeletonLoader(){let e=[,,,,].fill(null).map((e,t)=>this.html`
...
@keyframes loading {
    ...
    100% {
        ...
        `}};window.customElements.define(`plain-metagora-nav-menu`,Ce);var we=`.plain-greetings-wrapper {
    box-sizing: border-box;
...
@keyframes skeleton-shimmer {
    ...
    100% {
        ...
        `}};window.customElements.define(`plain-greetings`,Te);var Ee=`.plain-carousel-wrapper {
    height: 100%;
...
@media (max-height: 350px) {
    ...
    .tag {
        ...
        `}listeners(){let e=this.$$(`.dot`);e&&e.forEach((e,t)=>{e.onclick=()=>this.setSlide(t)})}};window.customElements.define(`plain-carousel`,De);var Oe=`.plain-metagora-hero-wrapper {
    width: 100%;
    height: 100%;
    position: relative;
...
}`,ke=class extends i{metagoraContext;words=[`Explore`,`Transform`,`Empower`,`Accelerate`,`Bound`,`Innovate`];currentWordIndex=0;intervalId=null;wordElement=null;constructor(){super(`plain-metagora-hero`,Oe),this.metagoraContext=this.useContext(m.METAGORA,!0)}template(){let e=this.metagoraContext.get(`agoras`)||[];return this.html`
            ...
            <section class="metagora-hero--content">
                <div class="metagora-hero--left">
                    ...
                    <div class="metagora-hero--cta-container">
                        ...
                        >
                            Know more about us
                            <span class="metagora-hero--cta-icon">${b}</span>
                        </a>
...
}`;function Me(e,t){return e?e.startsWith(`http://`)||e.startsWith(`https://`)?e:`${t}${e}`:``}function Ne(e,t,n,r,i){if(!e||!t)return i||`#`;let a=n.filter(e=>e._sourceHost===r);for(let n of a){let i=C(n.fields?.catalogues);for(let n of i)if(n.model===e)return`${r}/offering/${n.view_id}/${t}`}for(let i of n){let n=C(i.fields?.catalogues);for(let i of n)if(i.model===e)return`${r}/offering/${i.view_id}/${t}`}return i||`#`}function Pe(e,t=1){let n=e.startsWith(`#`)?e.slice(1):e,r=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),a=parseInt(n.slice(4,6),16);return`rgba(${r}, ${i}, ${a}, ${t})`}function Fe(e,t,n){if(!e||!t||t.length===0)return e;let r=e;return[...t].sort((e,t)=>t.length-e.length).forEach(e=>{if(!e)return;let t=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),i=RegExp(`\\b(${t}\\w*)`,`gi`),a=n.startsWith(`#`)?Pe(n,.2):`${n}33`;r=r.replace(i,`<mark style="background-color: ${a};">$1</mark>`)}),r}var Ie=`.score-badge {
    display: flex;
    align-items: center;
    gap: 0.375rem;
    background-color: #f3f4f6;
...
`,Le=class extends i{constructor(){super(`plain-score-badge`,Ie)}get score(){let e=this.props.score;if(e==null||e===`null`||e===``)return null;let t=parseFloat(e);return isNaN(t)?null:t}get aiPickTitle(){return this.props.aiPickTitle||`Suggested by AI assistant`}get matchTitle(){return this.props.matchTitle||`This is the relevance of the result`}template(){let e=this.score;return e===null?this.html`
        ...
        `}};window.customElements.define(`plain-score-badge`,Le);var Re=class extends i{result;configContext;serviceContext;modalContext;companyContext;constructor(){super(`plain-dynamic-card`,je),this.configContext=this.useContext(m.CONFIG),this.serviceContext=this.useContext(m.SERVICE),this.modalContext=this.useContext(m.MODAL),this.companyContext=this.useContext(m.COMPANY),this.result=JSON.parse(this.props.result)}getDetailUrl(){let e=this.result?._sourceHost||this.configContext.get(`API_HOST`);return Ne(this.result?.model,this.result?.data?.id,this.serviceContext.get(`services`)||[],e,this.result?.model_view_url)}getCardType(){let e=this.result?.data;if(!e)return`minimal`;let t=e?.name||e?.display_name,n=e?.x_summary||e?.x_description,r=e?.x_image,i=e?.x_origin||e?.x_home_partner_institution||e?.x_host_university||e?.x_hosting_university||e?.x_participating_universities,a=e?.x_web_link||e?.x_link||e?.x_more_info||e?.x_additional_link,o=this.result?.model_view_url;return t&&n&&r&&i&&a&&o?`full`:t&&n?`medium`:`minimal`}extractFullCard(){let e=this.result.data,t=e?.x_origin||e?.x_university_origin||e?.x_home_partner_institution||e?.x_host_university||e?.x_hosting_university||e?.x_participating_universities||``;return{score:this.result.score?.relative??null,image_url:e?.x_image||``,origins:w(t),name:e?.display_name||e?.name||``,summary:e?.x_summary||e?.x_description?E(e.x_summary||e.x_description):``,model_name:this.result?.model_verbose_name||``,detail_url:this.getDetailUrl(),additional_url:e?.x_web_link||e?.x_link||e?.x_more_info||e?.x_additional_link||``,catalogue_url:this.result.model_view_url||``}}extractMediumCard(){let e=this.result.data,t=e?.x_origin||e?.x_university_origin||e?.x_home_partner_institution||e?.x_host_university||e?.x_hosting_university||e?.x_participating_universities,n=t?w(t):[];return{score:this.result.score?.relative??null,origins:n.length>0?n:void 0,name:e?.display_name||e?.name||``,summary:e?.x_summary||e?.x_description?E(e.x_summary||e.x_description):``,model_name:this.result?.model_verbose_name||``,detail_url:this.getDetailUrl(),catalogue_url:this.result.model_view_url,additional_url:e?.x_web_link||e?.x_link||e?.x_more_info||e?.x_additional_link}}extractMinimalCard(){let e=this.result.data,t=e?.x_origin||e?.x_university_origin||e?.x_home_partner_institution||e?.x_host_university||e?.x_hosting_university||e?.x_participating_universities,n=t?w(t):[],r=this.result.score?.relative??null;return{name:e?.display_name||e?.name||`Untitled`,score:r,model_name:this.result?.model_verbose_name||``,origins:n.length>0?n:void 0}}getHighlightedText(e){let t=this.result?.roots||[],n=this.companyContext.get(`primaryColor`)||`#8238eb`;return Fe(e,t,n)}renderFullCard(){let e=this.extractFullCard(),t=this.result?._sourceHost||this.configContext.get(`API_HOST`),n=e.origins.length>0?e.origins.map(e=>this.html`
            ...
            <div class="card full-card">
                ${e.image_url?this.html`
                        <div class="card-image-container">
                            <div 
                                class="card-image" 
                                style="background-image: url('${Me(e.image_url,t)}')"
                            ></div>
                        </div>
                    `:``}
...
`;const D={RESULTS_FETCHED:`results-fetched`,RESULTS_CLEARED:`results-cleared`,CHAT_STARTED:`chat-started`,CHAT_USER_MESSAGE:`chat-user-message`,CHAT_MESSAGE_CHUNK:`chat-message-chunk`,CHAT_MESSAGE_COMPLETE:`chat-message-complete`,CHAT_RESULTS_UPDATED:`chat-results-updated`,CHAT_FETCHING_RESULTS:`chat-fetching-results`,NEW_CHAT:`new-chat`,MODE_SWITCH:`mode-switch`};function Je(e){return e.length&&Math.max(...e.map(e=>e.score))||1}function Ye(e,t){let n=e.filter(e=>e.service===t);return n.length&&Math.max(...n.map(e=>e.score))||1}function Xe(e,t,n=.1){return e.filter(e=>e.score[t]>=n)}function Ze(e,t){e.forEach(e=>{let n=t.find(t=>t.models.includes(e.model));n?(e.service=n.service,e.serviceCategory=n.category):(console.warn(`No service found for model: ${e.model}`),e.service=`unknown`,e.serviceCategory=`Other`)})}function Qe(e,t,n){let r=Je(e);return e.sort((e,t)=>t.score-e.score).map(i=>{let a=t.find(e=>e.model===i.model),o=a?.name||i.model,s=a?.website,c=a?.url,l=i._sourceHost||n,u=s?`${s}${c}`:`${l}${c}`,d=Ye(e,i.service);return{model:i.model,model_verbose_name:o,model_view_url:u,service:i.service,serviceCategory:i.serviceCategory||`Other`,featured_fields:i.featured_fields||[`web_link`,`url`,`website`],featured:i.featured||!1,data:i.data,roots:i.roots,score:{absolute:Number((i.score/r).toFixed(2)),relative:Number((i.score/d).toFixed(2))},_sourceHost:i._sourceHost}})}function $e(e){return[...new Set(e.map(e=>e.service))].sort().map(t=>{let n=e.filter(e=>e.service===t);return{service:t,items:n}})}function et(e){return[...new Set(e.map(e=>e.serviceCategory))].sort().map(t=>{let n=e.filter(e=>e.serviceCategory===t),r=[...new Set(n.map(e=>e.service))].sort().map(e=>({service:e,items:n.filter(t=>t.service===e)}));return{category:t,services:r}})}function tt(e,t,n=5){return e.filter(e=>e.toLowerCase().includes(t.toLowerCase())).reverse().slice(0,n)}function nt(e,t){let n=t.length,r=e.substring(0,n),i=e.substring(n);return{match:r,rest:i}}const rt={GPT_3_5_TURBO:`gpt-3.5-turbo`,GPT_4O:`gpt-4o`,GPT_4O_MINI:`gpt-4o-mini`,GEMINI_PRO:`gemini-pro`,GEMINI_1_5:`gemini-1.5`,CLAUDE_3:`claude-3`,CLAUDE_INSTANT_100K:`claude-instant-100k`,AZURE_GPT_3_5_TURBO:`azure-gpt-3.5-turbo`,AZURE_GPT_4:`azure-gpt-4`,AZURE_GPT_4O:`azure-gpt-4o`},it={OPENAI:`openai`,ANTHROPIC:`anthropic`,GOOGLE:`google`,AZURE:`azure`};var at=`:host {
    position: fixed;
    bottom: 20px;
    right: 20px;
    z-index: 10000;
...
.toast-item.success .toast-progress {
    background: rgba(255, 255, 255, 0.4);
} `,ot=class extends i{constructor(){super(`toast-container`,at)}template(){return this.html`
        ...
        `,t.appendChild(n);let a=n.querySelector(`.toast-close`);a&&a.addEventListener(`click`,()=>this.removeToast(n)),setTimeout(()=>{this.removeToast(n)},i)}removeToast(e){if(!e.parentElement)return;e.classList.remove(`fade-in`),e.classList.add(`fade-out`);let t=n=>{n.animationName===`slideOut`&&(e.removeEventListener(`animationend`,t),e.remove())};e.addEventListener(`animationend`,t)}getIcon(e){return{error:`✕`,warning:`⚠`,info:`ℹ`,success:`✓`}[e]}};function st(e,t=`info`,n=5e3){if(!h.DEBUG_MODE)return;let r=document.querySelector(`agora-app`)?.shadowRoot?.querySelector(`toast-container`);r&&r.addToast({message:e,type:t,duration:n})}function O(e,t){if(!h.DEBUG_MODE)return;let n=e instanceof Error?e.message:e,r=t?`[${t}] ${n}`:n;st(r,`error`,8e3)}window.customElements.define(`toast-container`,ot);var k={GET_AGORA_SERVICES:`/catalogue-api/v2/acceleration-services/1`,GET_AGORA_SEARCH_RESULTS:`/elastic/search`,GET_AGORA_INGEST_MODEL:`/elastic/ingest`,SEND_MESSAGE:`/assistant/rag/stream`,FETCH_ELEMENT:`/catalogue-api/v2`,GET_AIDA_API_KEY:`/catalogue-api/v2/api-key/aida`,GET_HOME_VISUAL_CONFIG:`/catalogue-api/v2/home-visual-config`};async function ct(e,t={}){let{maxRetries:n=2,timeoutMs:r=5e3,delayMs:i=1e3}=t,a=null;for(let t=0;t<=n;t++){let o=new AbortController,s=setTimeout(()=>o.abort(),r);try{let t=await fetch(e,{signal:o.signal});return clearTimeout(s),t}catch(e){clearTimeout(s),a=e,t<n&&await new Promise(e=>setTimeout(e,i))}}throw a}const A={GET_ALL_AGORA_URLS:async()=>[`https://agora.unite-university.eu/`,`https://eugreen.pre.widening.eu/`,`https://eudres.widening.eu/`,`https://civis.widening.eu/`,`https://aupaeu.widening.eu/`,`https://forthem.widening.eu/`,`https://eutopia-agora.widening.eu/`,`https://circle-u.widening.eu/`,`https://heroes.widening.eu/`,`https://uninovis.widening.eu/`,`https://foreu4all.widening.eu/`],GET_AGORA_SERVICES:async e=>{try{let t=`${e}${k.GET_AGORA_SERVICES}`,n=await fetch(t);if(!n.ok)throw O(Error(`Failed to fetch Agora services from ${t}`),`GET_AGORA_SERVICES`),Error(`Something went wrong while fetching the Agora services`);return await n.json()}catch(e){throw O(e,`GET_AGORA_SERVICES`),e}},GET_AGORA_SEARCH_RESULTS:async(e,t,n,r,i)=>{if(!t||t.length===0)throw Error(`No query provided`);if(n.length===0)throw Error(`No models provided for the search`);let a=`${e}${k.GET_AGORA_SEARCH_RESULTS}?query=${t}&models=${n.join()}`;try{let e=await fetch(a);if(!e.ok&&e.status===404){let t=await e.json();throw Error(JSON.stringify(t))}return await e.json()}catch(e){throw O(e,`GET_AGORA_SEARCH_RESULTS`),e}},GET_AGORA_INGEST_MODEL:async(e,t)=>{let n=`${e}${k.GET_AGORA_INGEST_MODEL}/${t}`;try{let e=await fetch(n);if(!e.ok){let t=await e.json();throw Error(t.message)}return await e.json()}catch(e){throw O(e,`GET_AGORA_INGEST_MODEL`),e}},SEND_MESSAGE:async(e,t,n=[],r=``,i=rt.GPT_4O_MINI,a=it.OPENAI,o=.7)=>{let s={message:t,history:n,context:r,model:i,provider:a,temperature:o},c=`${e}${k.SEND_MESSAGE}`;try{let e=await fetch(c,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(s)});if(!e.ok)throw Error(`Something went wrong while sending message`);return e.body instanceof ReadableStream?e:await e.json()}catch(e){throw O(e,`SEND_MESSAGE`),e}},FETCH_ELEMENT:async(e,t,n)=>{let r=`${e}${k.FETCH_ELEMENT}/${t}/${n}`;try{let e=localStorage.getItem(`aida_ak`);if(!e)throw Error(`AIDA API key not found. Please ensure you are properly authenticated.`);let i=await fetch(r,{method:`GET`,headers:{accept:`application/json`,Authorization:`Bearer ${e}`}});if(!i.ok){if(i.status===404){let e=await i.json();throw Error(JSON.stringify(e))}if(i.status===401||i.status===403){let e=await i.json();throw Error(JSON.stringify(e))}throw Error(`Failed to fetch element ${t}/${n}`)}return await i.json()}catch(e){throw O(e,`FETCH_ELEMENT`),e}},GET_AIDA_API_KEY:async(e,t=[])=>{try{let n=new URLSearchParams;t&&t.length>0&&n.append(`models`,t.join(`,`));let r=`${e}${k.GET_AIDA_API_KEY}${n.toString()?`?${n.toString()}`:``}`,i=await fetch(r,{method:`GET`,headers:{accept:`application/json`}});if(!i.ok){if(i.status===400){let e=await i.json();throw Error(e.error?.message||`Bad request when fetching API key`)}if(i.status===500){let e=await i.json();throw Error(e.error?.message||`Server error when fetching API key`)}throw Error(`Something went wrong while fetching AIDA API key`)}return await i.json()}catch(e){throw O(e,`GET_AIDA_API_KEY`),e}},GET_MULTIPLE_AIDA_API_KEYS:async(e,t={})=>{let n={};return await Promise.all(e.map(async e=>{try{let r=await A.GET_AIDA_API_KEY(e,t[e]);r?.token?.jwt_token&&(n[e]=r.token.jwt_token)}catch(t){console.warn(`Failed to fetch API key for host: ${e}`,t)}})),n},GET_HOME_VISUAL_CONFIG:async e=>{try{let t=`${e}${k.GET_HOME_VISUAL_CONFIG}`,n=await ct(t);return n.ok?await n.json():(console.warn(`Failed to fetch visual config from ${t} (status: ${n.status})`),null)}catch(e){return console.warn(`Error fetching home visual config:`,e),null}}},j=(e,t)=>{let n=[];function r(e){for(let i in e)Object.prototype.hasOwnProperty.call(e,i)&&(i===t&&n.push({[t]:e[i]}),typeof e[i]==`object`&&e[i]!==null&&r(e[i]))}return r(e),n};var lt=class{deps;callbacks;messageBuffer=``;isFirstChunk=!0;shouldResetResults=!1;constructor(e,t){this.deps=e,this.callbacks=t}async chat(e){if(!e){console.warn(`No message provided`);return}this.callbacks.showSpinner(),this.isFirstChunk=!0,this.messageBuffer=``,this.deps.signals.emit(D.CHAT_STARTED),this.storeMessageInChatContext(e,`user`),this.deps.signals.emit(D.CHAT_USER_MESSAGE);try{let t=this.deps.configContext.get(`AI_HOST`),n=this.formatMessageHistory(),r=this.extractMentionsFromMessage(e),i=this.filterResultsByMentions(r),a=this.buildChatContext(i),o=await A.SEND_MESSAGE(t,e,n,a);if(o.body instanceof ReadableStream)await this.handleStreamingResponse(o);else{let e=o,t=e.response||e.message||``;this.storeMessageInChatContext(t,`ai`),this.deps.signals.emit(D.CHAT_MESSAGE_COMPLETE,t)}}catch(e){console.error(`Chat error:`,e)}finally{this.callbacks.hideSpinner(),this.shouldResetResults=!0}}buildChatContext(e){let t=this.deps.companyContext.get(`name`)||`the alliance`,n=this.deps.resultContext.get(`data`)?.length||0,r=e.map(e=>` >> Resource: ${JSON.stringify(e)}\n`),i=[`You are a helpful assistant working in the Metagora platform.`,`Metagora is a HUB that grants access to all university resources and services within all the university alliances that are using the Agora platform.`,`Agora is a platform to manage and share university resources within a university alliance.`,`An Agora is a service that serves as a central hub that provides access to services and resources offered by the alliance members.`,`A university alliance is a collaboration between multiple universities to share resources, knowledge, and services for the benefit of their students and staff.`,`This site is the Metagora.`].join(`
`)+`
...
`,s,o].join(`
`)}formatMessageHistory(){return(this.deps.chatContext.get(`history`)||[]).map(e=>({role:e.author===`user`?`user`:`ai`,content:e.content}))}storeMessageInChatContext(e,t){if(!e||e.trim()===``)return;let n=this.deps.chatContext.get(`history`)||[];n.push({content:e,author:t,time:new Date().toLocaleTimeString()}),this.deps.chatContext.set({history:n}),this.callbacks.updateClearButtonVisibility()}async handleStreamingResponse(e){let t=e.body.getReader(),n=new TextDecoder;try{for(;;){let{done:e,value:r}=await t.read();if(e)break;let i=n.decode(r,{stream:!0});this.handleChunk(i)}this.messageBuffer&&=(this.storeMessageInChatContext(this.messageBuffer,`ai`),this.deps.signals.emit(D.CHAT_MESSAGE_COMPLETE,this.messageBuffer),``)}catch(e){throw console.error(`Stream reading error:`,e),e}}splitChunkByTags(e){let t=/(\[\$\w+\])(.*?)(?=\[\$\w+\]|$)/gs,n=[],r;for(;(r=t.exec(e))!==null;){let e=r[1],t=r[2];if(e===`[$done]`){n.length>0&&(n[n.length-1].content+=` [$done]`);continue}n.push({tag:e,content:t})}return n}handleChunk(e){this.splitChunkByTags(e).forEach(e=>{if(e.tag===`[$artifact]`)try{let t=JSON.parse(e.content.replace(/'/g,`"`));this.handleChatResults(t)}catch(e){console.error(`Error parsing artifact:`,e)}else if(e.tag===`[$message]`){let t=e.content.includes(`[$done]`),n=t?e.content.split(`[$done]`)[0]:e.content;this.handleChatMessage({isFirstChunk:this.isFirstChunk,isLastChunk:t,message:n}),this.isFirstChunk&&=!1}})}handleChatMessage(e){if(e.isFirstChunk&&this.callbacks.hideSpinner(),e.isLastChunk){let t=this.messageBuffer+e.message;this.storeMessageInChatContext(t,`ai`),this.deps.signals.emit(D.CHAT_MESSAGE_COMPLETE,t),this.messageBuffer=``;return}this.messageBuffer+=e.message,e.message&&this.deps.signals.emit(D.CHAT_MESSAGE_CHUNK,{chunk:e.message,fullMessage:this.messageBuffer})}async handleChatResults(e){if(!e||e.length===0)return;let t={grouped:[],data:[]};this.shouldResetResults||(t.data=this.deps.resultContext.get(`data`)||[],t.grouped=this.deps.resultContext.get(`grouped`)||[]),this.shouldResetResults&&=!1;let n=this.deps.serviceContext.get(`services`)||[],r=j(n,`websites`).flatMap(e=>e.websites),i={},a=e=>{t.data.push(e),t.grouped=[...new Set(t.data.map(e=>e.service))].sort().map(e=>({service:e,items:t.data.filter(t=>t.service===e)})),this.deps.resultContext.set(t,!0),this.deps.signals.emit(D.CHAT_RESULTS_UPDATED,t.grouped),this.deps.signals.emit(D.RESULTS_FETCHED,t.data)};this.deps.signals.emit(D.CHAT_FETCHING_RESULTS,!0),(async()=>{for(let t of e){i[t.model]=r.find(e=>e.model===t.model)?.name||null;let e=t.model,o=null;if(n.forEach(t=>{let n=t.fields?.catalogues?.websites;if(!n)return;let r={};n.forEach(t=>{if(!t.model||t.model!==e)return;let n={model:t.model,model_verbose_name:t.model_verbose_name,model_website:t.website,model_view_url:t.url,model_view_id:t.view_id};r[t.model]=n}),e in r&&(o={service:t.fields.name,serviceCategory:T(t.fields.category),models:r})}),!o)continue;let s=o,c;try{c=await A.FETCH_ELEMENT(this.deps.configContext.get(`API_HOST`),t.model,Number(t.source_id))}catch(e){console.error(`Error fetching element:`,e);continue}if(!c)continue;Object.entries(c.fields).forEach(([e,t])=>{if(typeof t==`string`&&(t.startsWith(`[`)||t.startsWith(`{`)))try{let n=xe(t);n&&(c.fields[e]=n.name||t)}catch(n){console.warn(`Could not parse field ${e} with value ${t} as JSON:`,n)}});let l=c.fields?.x_image||null;l&&=l.replace(this.deps.configContext.get(`API_HOST`),``);let u=c.fields?.detail_url?s.models[e].model_website+s.models[e].model_view_url:null,d={data:{...c.fields,id:c.id,image:l},featured:c.fields?.featured||!1,featured_fields:[`web_link`,`url`,`website`],model:t.model,model_verbose_name:i[t.model],model_view_url:u,roots:[],score:{absolute:null,relative:null},service:s.service,serviceCategory:s.serviceCategory};a(d)}this.deps.signals.emit(D.CHAT_FETCHING_RESULTS,!1)})()}extractMentionsFromMessage(e){let t=/@([^@\n]+?)(?=\s*@|\s*$)/g,n=[],r;for(;(r=t.exec(e))!==null;){let e=r[1].trim();e&&n.push(e.toLowerCase())}return n}filterResultsByMentions(e){return e.length===0?[]:(this.deps.resultContext.get(`data`)||[]).filter(t=>{let n=this.getResultDisplayName(t).toLowerCase();return e.some(e=>n.includes(e)||e.includes(n))})}getResultDisplayName(e){let t=e.data||{};for(let e of[`name`,`title`,`Name`,`Title`,`headline`,`label`,`display_name`])if(t[e]&&typeof t[e]==`string`)return t[e];return e.model_verbose_name||``}clearChatHistory(){this.deps.chatContext.set({history:[]}),this.messageBuffer=``}newChat(e){this.deps.chatContext.set({history:[]}),this.messageBuffer=``,e(),this.deps.signals.emit(D.NEW_CHAT)}};const ut=async(e,t,n)=>{if(!t||t.trim()===``)return console.warn(`No query provided`),{data:null};if(n.length===0)return console.warn(`No models provided`),{data:null};let r={raw:t,translated:t};try{return{data:await A.GET_AGORA_SEARCH_RESULTS(e,r.translated,n)}}catch(e){throw console.log(`Error during query:`,JSON.parse(e.message)),O(e,`Search Query`),e}},dt=async(e,t)=>{try{return st(`Elasticsearch is ingesting the missing model data.\n
            Ingesting missing data from the model: '${t}' into Elasticsearch`,`warning`,1e4),console.warn(`ELASTICSEARCH IS INGESTING\nIngesting missing data from the model: '${t}' into Elasticsearch`),await A.GET_AGORA_INGEST_MODEL(e,t),null}catch(e){return O(e,`Model Data Ingestion`),e}};var ft=class{props;callbacks;constructor(e,t){this.props=e,this.callbacks=t}async search(e){let t=this.props.serviceContext.get(`models`);if(!e||e.trim()===``){console.warn(`No query provided`);return}if(t.length===0){console.warn(`No models provided`);return}this.callbacks.hideSuggestions(),this.callbacks.showSpinner();let n=this.sanitizeQuery(e);if(this.props.configContext.get(`IS_METAGORA`)){let t=this.props.serviceContext.get(`modelsByAgora`)||{},r=new Map;await Promise.all(Object.entries(t).map(async([e,t])=>{if(t.length===0){console.warn(`No models available for Agora at host ${e}`);return}try{let i=(await ut(e,n,t)).data.results;r.set(e,i)}catch(t){console.error(`Error querying Agora at host ${e}\n${t}`),r.set(e,[])}})),this.callbacks.hideSpinner(),this.handleMetagoraSearchResults(e,r);return}try{let r=await ut(this.props.configContext.get(`API_HOST`),n,t);this.callbacks.hideSpinner();let i=r.data.results;this.handleSearchResults(e,i)}catch(t){try{let n=JSON.parse(t.message);if(n.missing_model){let t=await dt(this.props.configContext.get(`API_HOST`),n.missing_model);if(t){console.error(`ELASTICSEARCH INGESTION ERROR\n${t}`),this.callbacks.hideSpinner();return}await this.search(e)}}catch{throw console.error(`SEARCH ERROR\n${t}`),this.callbacks.hideSpinner(),t}}}sanitizeQuery(e){console.log(`Raw query:`,e);let t=e.normalize(`NFC`).replace(/[^\p{L}\p{N} ]/gu,``);return console.log(`Sanitized query:`,t),t}handleSearchResults(e,t,n=!1){if(this.props.signals.emit(D.RESULTS_FETCHED,t),this.callbacks.updateClearButtonVisibility(t.length>0),t.length===0){this.props.resultContext.set({data:[],grouped:[]},!0);return}this.storeQueryInContext({raw:e,translated:e});let r=this.props.serviceContext.get(`services`),i=[...new Set(r.map(e=>({service:e.fields.name,category:T(e.fields.category),models:j(e,`model`).map(e=>e.model)})))];Ze(t,i);let a=j(r,`websites`).flatMap(e=>e.websites),o=Qe(t,a,this.props.configContext.get(`API_HOST`)),s=Xe(o,`absolute`),c=$e(s);this.props.resultContext.set({data:s,grouped:c},!0)}handleMetagoraSearchResults(e,t){let n=[];if(t.forEach((e,t)=>{let r=e.map(e=>({...e,_sourceHost:t}));n.push(...r)}),this.props.signals.emit(D.RESULTS_FETCHED,n),this.callbacks.updateClearButtonVisibility(n.length>0),n.length===0){this.props.resultContext.set({data:[],grouped:[]},!0);return}this.storeQueryInContext({raw:e,translated:e});let r=this.props.serviceContext.get(`services`),i=[...new Set(r.map(e=>({service:e.fields.name,category:T(e.fields.category),models:j(e,`model`).map(e=>e.model)})))];Ze(n,i);let a=j(r,`websites`).flatMap(e=>e.websites),o=Qe(n,a,``),s=Xe(o,`absolute`),c=et(s),l=c.flatMap(e=>e.services);this.props.resultContext.set({data:s,grouped:l,groupedByCategory:c},!0)}storeQueryInContext(e){let t=this.props.searchContext.get(`history`)||[],n={history:[...new Set([...t,e.raw])],current:e.translated.split(` `)};this.props.searchContext.set(n)}},pt=class{deps;constructor(e){this.deps=e}checkForMention(e,t){let n=-1;for(let r=t-1;r>=0;r--){let t=e[r];if(t===` `||t===`
...
`}</button>
                    ...
                    <div class="card-body">
                        <span class="icon globe-icon">${this.activeMode===`search`?oe:_}</span>
                        <textarea 
                            placeholder="${r}"  
                            rows="1" 
                            maxlength="100"
        ...
        `}afterRender(){this.updateClearButtonVisibility()}listeners(){let e=this.$(`.tab[data-mode="search"]`),t=this.$(`.tab[data-mode="chat"]`),n=this.$(`.go-btn`),r=this.$(`.clear-btn-header`),i=this.$(`.new-chat-btn`),a=this.$(`textarea`);e&&(e.onclick=e=>this.toggleMode(`search`,e)),t&&(t.onclick=e=>this.toggleMode(`chat`,e)),n&&(n.onclick=()=>this.handleSubmit()),r&&(r.onclick=()=>this.clear()),i&&(i.onclick=()=>this.newChat()),a&&(a.onkeydown=e=>this.handleKeyDown(e)),a&&(a.oninput=e=>this.handleInput(e))}handleSubmit(){let e=this.$(`textarea`),t=e?.value?.trim()||``;this.activeMode===`search`?this.searchHandler.search(t):(e.value=``,this.chatHandler.chat(t))}showSpinner(){let e=this.$(`.go-btn`),t=this.$(`textarea`);e&&(e.querySelector(`plain-spinner`)||(e.dataset.originalHtml=e.innerHTML,e.innerHTML=`<plain-spinner></plain-spinner>`,e.disabled=!0,e.style.cursor=`not-allowed`,t&&(t.disabled=!0,t.style.cursor=`not-allowed`,t.style.opacity=`0.6`)))}hideSpinner(){let e=this.$(`.go-btn`),t=this.$(`textarea`);e&&(e.innerHTML=e.dataset.originalHtml||he,e.disabled=!1,e.style.cursor=`pointer`,t&&(t.disabled=!1,t.style.cursor=`text`,t.style.opacity=`1`,t.focus()))}clear(){let e=this.$(`textarea`);e&&(e.value=``,e.focus()),this.hideSuggestions(),this.$(`.clear-btn-header`)?.classList.add(`hidden`),this.resultContext.set({data:[],grouped:[]},!0),this.signals.emit(D.RESULTS_CLEARED);let t=this.searchContext.get(`history`)||[];this.searchContext.set({history:t,current:[]}),this.filterContext.set([],`filters`,!0)}updateClearButtonVisibility(){let e=this.$(`.clear-btn-header`),t=this.$(`.new-chat-btn`),n=this.resultContext.get(`data`)||[],r=this.chatContext.get(`history`)||[];n.length>0?e?.classList.remove(`hidden`):e?.classList.add(`hidden`),r.length>0?t?.classList.remove(`hidden`):t?.classList.add(`hidden`)}newChat(){let e=this.$(`.new-chat-btn`);this.chatHandler.newChat(()=>e?.classList.add(`hidden`))}handleInput(e){let t=e.target,n=t.value,r=t.selectionStart||0;if(this.activeMode===`chat`){let e=this.mentionHandler.checkForMention(n,r);if(e.isMentioning&&(this.isMentioning=!0,this.mentionStartIndex=e.startIndex,this.mentionResults=this.mentionHandler.filterMentionResults(e.query),this.activeMentionIndex=this.mentionResults.length>0?0:-1,this.mentionResults.length>0)){this.renderMentions(),this.showMentions();return}}this.hideMentions(),this.isMentioning=!1;let i=n.trim().toLowerCase();if(!i){this.hideSuggestions();return}if(this.activeMode!==`search`){this.hideSuggestions();return}let a=this.searchContext.get(`history`)||[];this.suggestions=tt(a,i),this.activeSuggestionIndex=-1,this.suggestions.length>0?(this.renderSuggestions(i),this.showSuggestions()):this.hideSuggestions()}renderMentions(){let e=this.$(`.mentions`);e&&(e.innerHTML=`
        ...
        `,e.querySelectorAll(`.mention-item`).forEach((e,t)=>{e.onmousedown=e=>{e.preventDefault(),this.selectMention(this.mentionResults[t])},e.onmouseenter=()=>{this.activeMentionIndex=t,this.renderMentions()}}))}showMentions(){let e=this.$(`.mentions`),t=this.$(`.search-card`);e?.classList.remove(`hidden`),t?.classList.add(`has-mentions`)}hideMentions(){let e=this.$(`.mentions`),t=this.$(`.search-card`);e?.classList.add(`hidden`),t?.classList.remove(`has-mentions`),this.mentionResults=[],this.activeMentionIndex=-1}selectMention(e){let t=this.$(`textarea`);if(!t)return;let n=t.selectionStart||0,{newText:r,newCursorPosition:i}=this.mentionHandler.buildMentionText(t.value,this.mentionStartIndex,n,e.name);t.value=r,t.setSelectionRange(i,i),this.hideMentions(),this.isMentioning=!1,t.focus()}showSuggestions(){let e=this.$(`.suggestions`),t=this.$(`.search-card`);e?.classList.remove(`hidden`),t?.classList.add(`has-suggestions`)}hideSuggestions(){let e=this.$(`.suggestions`),t=this.$(`.search-card`);e?.classList.add(`hidden`),t?.classList.remove(`has-suggestions`)}renderSuggestions(e){let t=this.$(`.suggestions`);t&&(t.innerHTML=`
            <div class="suggestions-content">
                ${this.suggestions.map((t,n)=>{let{match:r,rest:i}=nt(t,e);return`
...
`;const M={catalogue:[`model_verbose_name`],service:[`service`],serviceCategory:[`serviceCategory`],agora:[`_sourceHost`],origin:[`origin`,`x_origin`,`x_home_partner_institution`,`x_home_university`,`x_participating_universities`,`x_host_university`,`x_university`,`x_university_origin`]};var vt=class extends i{selectedFilters;resultContext;filterContext;companyContext;metagoraContext;isCollapsed=!1;collapsedSections=new Set;sectionsInitialized=!1;constructor(){super(`plain-filter-widget`,_t),this.resultContext=this.useContext(m.RESULT,!0),this.filterContext=this.useContext(m.FILTER),this.companyContext=this.useContext(m.COMPANY),this.metagoraContext=this.useContext(m.METAGORA),this.selectedFilters=this.useState({mapping:M,filters:{}}),this.initiFilters()}initiFilters(){let e=this.filterContext.get();this.selectedFilters.set({mapping:M,filters:e?.filters||{}})}getAgoraNameFromHost(e){return(this.metagoraContext.get(`agoras`)||[]).find(t=>t.host===e)?.name||e}truncateText(e,t=30){return e.length<=t?e:e.substring(0,t)+`...`}updateAvailableFilters(){let e=this.resultContext.get()?.data||[],t=Object.values(M).flatMap(e=>e),n={service:[],origin:[],catalogue:[],serviceCategory:[],agora:[]};return t.map(t=>{e.map(e=>{let r=j(e,t),i=Object.keys(M).find(e=>M[e].includes(t));if(!i||![`service`,`origin`,`catalogue`,`serviceCategory`,`agora`].includes(i))return;let a=r.map(e=>e[t]);if(a=a.filter(e=>e),i===`origin`){let e=a.flatMap(e=>w(e));n[i].push(...e)}else if(i===`agora`){let e=a.map(e=>({label:this.getAgoraNameFromHost(e),value:e}));n[i].push(...e)}else n[i].push(...a);if(i===`agora`){let e=new Set;n[i]=n[i].filter(t=>e.has(t.value)?!1:(e.add(t.value),!0))}else n[i]=Array.from(new Set(n[i]))})}),n}clearFilters(){let e={mapping:M,filters:{}};this.selectedFilters.set(e),this.filterContext.set(e,!0)}toggleCollapse(){this.isCollapsed=!this.isCollapsed,this.$(`.filter-widget`)?.classList.toggle(`collapsed`,this.isCollapsed)}toggleSection(e){this.collapsedSections.has(e)?this.collapsedSections.delete(e):this.collapsedSections.add(e),this.render()}template(){if((this.resultContext.get()?.data||[]).length===0)return``;let e=this.updateAvailableFilters(),t=Object.values(e).flatMap(e=>e).length>0;t&&!this.sectionsInitialized&&(this.sectionsInitialized=!0,[`origin`,`service`,`catalogue`,`serviceCategory`,`agora`].forEach(t=>{e[t]&&e[t].length>1&&this.collapsedSections.add(t)}));let n=this.companyContext.get(`primaryColor`);n&&this.style.setProperty(`--primary-color`,n);let r=e.origin.length>1?this.html`
...
@media (max-width: 480px) {
    .ellipse {
...
}`,bt=class extends i{constructor(){super(`plain-intro-animation`,yt),setTimeout(()=>{let e=this.$(`.central-square`);e&&(e.style.opacity=`0`),setTimeout(()=>{this.style.opacity=`0`,setTimeout(()=>{this.remove()},1e3)},500)},3e3)}template(){return this.html`
            <div class="central-square">
                <section class="s_aupaeu_animated_background background-container" >
                    <div class="gradient-layer"></div>
                    <div class="ellipse ellipse-323"></div>
        ...
        `}};window.customElements.define(`plain-intro-animation`,bt);var xt=`.plain-detail-modal-wrapper {
    pointer-events: none;
    position: fixed;
    top: 0;
    left: 0;
...
@media (max-width: 900px) {
    ...
    .modal-title {
        ...
        `}listeners(){let e=this.$(`.modal-overlay`),t=this.$(`.close-btn`);e&&(e.onclick=t=>{t.target===e&&this.close()}),t&&(t.onclick=()=>this.close())}};window.customElements.define(`plain-detail-modal`,St);var Ct=`.plain-chat-window-wrapper {
    width: 100%;
    height: 100%;
...
}`;function N(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var P=N();function wt(e){P=e}var F={exec:()=>null};function I(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(L.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var Tt=(()=>{try{return!0}catch{return!1}})(),L={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,`i`)},Et=/^(?:[ \t]*(?:\n|$))+/,Dt=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Ot=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,R=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,kt=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,z=/(?:[*+-]|\d{1,9}[.)])/,At=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,jt=I(At).replace(/bull/g,z).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),Mt=I(At).replace(/bull/g,z).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Nt=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Pt=/^[^\n]+/,Ft=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,It=I(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,Ft).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Lt=I(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,z).getRegex(),B=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,Rt=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,zt=I(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,Rt).replace(`tag`,B).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Bt=I(Nt).replace(`hr`,R).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,B).getRegex(),Vt={blockquote:I(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,Bt).getRegex(),code:Dt,def:It,fences:Ot,heading:kt,hr:R,html:zt,lheading:jt,list:Lt,newline:Et,paragraph:Bt,table:F,text:Pt},Ht=I(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,R).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,B).getRegex(),Ut={...Vt,lheading:Mt,table:Ht,paragraph:I(Nt).replace(`hr`,R).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,Ht).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,B).getRegex()},Wt={...Vt,html:I(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,Rt).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:F,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:I(Nt).replace(`hr`,R).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,jt).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},Gt=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Kt=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,qt=/^( {2,}|\\)\n(?!\s*$)/,Jt=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,V=/[\p{P}\p{S}]/u,Yt=/[\s\p{P}\p{S}]/u,Xt=/[^\s\p{P}\p{S}]/u,Zt=I(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,Yt).getRegex(),Qt=/(?!~)[\p{P}\p{S}]/u,$t=/(?!~)[\s\p{P}\p{S}]/u,en=/(?:[^\s\p{P}\p{S}]|~)/u,tn=I(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,Tt?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),nn=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,rn=I(nn,`u`).replace(/punct/g,V).getRegex(),an=I(nn,`u`).replace(/punct/g,Qt).getRegex(),on=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,sn=I(on,`gu`).replace(/notPunctSpace/g,Xt).replace(/punctSpace/g,Yt).replace(/punct/g,V).getRegex(),cn=I(on,`gu`).replace(/notPunctSpace/g,en).replace(/punctSpace/g,$t).replace(/punct/g,Qt).getRegex(),ln=I(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,Xt).replace(/punctSpace/g,Yt).replace(/punct/g,V).getRegex(),un=I(/\\(punct)/,`gu`).replace(/punct/g,V).getRegex(),dn=I(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),fn=I(Rt).replace(`(?:-->|$)`,`-->`).getRegex(),pn=I(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,fn).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),H=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,mn=I(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace(`label`,H).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),hn=I(/^!?\[(label)\]\[(ref)\]/).replace(`label`,H).replace(`ref`,Ft).getRegex(),gn=I(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,Ft).getRegex(),_n=I(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,hn).replace(`nolink`,gn).getRegex(),vn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,yn={_backpedal:F,anyPunctuation:un,autolink:dn,blockSkip:tn,br:qt,code:Kt,del:F,emStrongLDelim:rn,emStrongRDelimAst:sn,emStrongRDelimUnd:ln,escape:Gt,link:mn,nolink:gn,punctuation:Zt,reflink:hn,reflinkSearch:_n,tag:pn,text:Jt,url:F},bn={...yn,link:I(/^!?\[(label)\]\((.*?)\)/).replace(`label`,H).getRegex(),reflink:I(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,H).getRegex()},xn={...yn,emStrongRDelimAst:cn,emStrongLDelim:an,url:I(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,vn).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:I(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,vn).getRegex()},Sn={...xn,br:I(qt).replace(`{2,}`,`*`).getRegex(),text:I(xn.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},U={normal:Vt,gfm:Ut,pedantic:Wt},W={normal:yn,gfm:xn,breaks:Sn,pedantic:bn},Cn={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},wn=e=>Cn[e];function G(e,t){if(t){if(L.escapeTest.test(e))return e.replace(L.escapeReplace,wn)}else if(L.escapeTestNoEncode.test(e))return e.replace(L.escapeReplaceNoEncode,wn);return e}function Tn(e){try{e=encodeURI(e).replace(L.percentDecode,`%`)}catch{return null}return e}function En(e,t){let n=e.replace(L.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(L.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(L.slashPipe,`|`);return n}function K(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function Dn(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function On(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`);r.state.inLink=!0;let c={type:e[0].charAt(0)===`!`?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:r.inlineTokens(s)};return r.state.inLink=!1,c}function kn(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
...
`)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let e=t[0],n=kn(e,t[3]||``,this.rules);return{type:`code`,raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,`$1`):t[2],text:n}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let t=K(e,`#`);(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:`heading`,raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:`hr`,raw:K(t[0],`
...
`}
        ...
        `}initializeHandlers(){this.contextHandler=new Vn({configContext:this.configContext,companyContext:this.companyContext,serviceContext:this.serviceContext,modalContext:this.modalContext,metagoraContext:this.metagoraContext,visualConfigContext:this.visualConfigContext,getAttribute:e=>this.getAttribute(e),hasAttribute:e=>this.hasAttribute(e)}),this.layoutHandler=new Hn({resultContext:this.resultContext,chatContext:this.chatContext,$:e=>this.$(e)},{getCurrentMode:()=>this.currentMode,setCurrentMode:e=>{this.currentMode=e},getPanelHandler:()=>this.panelHandler}),this.panelHandler=new Un({resultContext:this.resultContext,$:e=>this.$(e)})}async init(){await this.contextHandler.initializeAll()}afterRender(){let e=this.configContext.get(`MAX_HEIGHT`),t=this.visualConfigContext.get(`background_image`),n=this.visualConfigContext.get(`title_font`),r=this.visualConfigContext.get(`body_font`),i=typeof t==`string`&&t.trim().length>0,a=this.shadowRoot?.querySelector(`.agora-app-wrapper`);a&&(e&&(a.style.maxHeight=e),a.style.setProperty(`--agora-font-title`,zn(n,`Sora`)),a.style.setProperty(`--agora-font-body`,zn(r,`Geist`)),i?(a.classList.add(`agora-app-wrapper--with-background`),a.style.setProperty(`--agora-wrapper-bg-image`,`url('${encodeURI(t.trim())}')`)):(a.classList.remove(`agora-app-wrapper--with-background`),a.style.removeProperty(`--agora-wrapper-bg-image`)))}connectors(){this.setupSignalConnections(),this.panelHandler.setupEventListeners(),this.layoutHandler.initializeLayout()}setupSignalConnections(){let e=this.$(`plain-agora-input`),t=this.$(`plain-chat-window`);e&&(this.signals.connect(e,D.RESULTS_FETCHED,e=>this.layoutHandler.updateVisibility(e)),this.signals.connect(e,D.RESULTS_CLEARED,()=>this.layoutHandler.updateVisibility(null))),t&&(this.signals.connect(e,D.CHAT_USER_MESSAGE,()=>{t.handleUserMessage()}),this.signals.connect(e,D.CHAT_MESSAGE_CHUNK,e=>{t.handleMessageChunk(e)}),this.signals.connect(e,D.CHAT_MESSAGE_COMPLETE,()=>{t.handleMessageComplete()}),this.signals.connect(e,D.CHAT_FETCHING_RESULTS,e=>{t.handleFetchingResults(e)}),this.signals.connect(e,D.CHAT_STARTED,()=>{this.layoutHandler.showChatWindow()}),this.signals.connect(e,D.NEW_CHAT,()=>{this.layoutHandler.resetToInitialState(),t.render()}),this.signals.connect(e,D.MODE_SWITCH,e=>{this.layoutHandler.handleModeSwitch(e)}))}};window.customElements.define(`${h.IS_METAGORA?`metagora`:`agora`}-app-v2`,Wn);